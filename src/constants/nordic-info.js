...
export const NORDIC_INFO = [
	{
		...
		2: {
			...
			beingTwo: {
				...
				caption:
					'Ragnarök, the end of the world in Norse mythology, is the apocalyptic battle where gods, giants, and creatures clash in a cosmic struggle. Fenrir kills Odin, Thor faces Jörmungandr, and Surtr engulfs the world in flames. This chaotic event signifies the destruction of the old order, but also the promise of renewal as a new world emerges. Ragnarök encapsulates themes of destiny, cyclical time, and the inevitable balance between creation and destruction in Norse belief.'
			},
			beingThree: {
				name: 'SKÖL AND HATI',
				tab: 'SKÖL',
