...
export const GREEK_INFO = [
	{
		id: v4(),
		color: COLORS.greek,
		banner: {
			mobile: 'public/assets/images/greek/banner-mobile.jpg',
			tablet: 'public/assets/images/greek/banner-tablet.jpg',
			desktop: 'public/assets/images/greek/banner-desktop.jpg'
		},
		kind: 'GREEK MITHOLOGY',
		0: {
			beingOne: {
				name: 'ZEUS',
				image: {
					mobile: 'public/assets/images/greek/zeus-mobile.jpg',
					tablet: 'public/assets/images/greek/zeus-tablet.jpg',
					desktop: 'public/assets/images/greek/zeus-desktop.jpg'
				},
				caption:
			...
			beingTwo: {
				name: 'ATHENEA',
				image: {
					mobile: 'public/assets/images/greek/athenea-mobile.jpg',
					tablet: 'public/assets/images/greek/athenea-tablet.jpg',
					desktop: 'public/assets/images/greek/athenea-desktop.jpg'
				},
				caption:
					'Athena, the Greek goddess of wisdom, war, and strategic battle, is one of the most revered deities in Greek mythology. Known for her intelligence, courage, and calm demeanor, she embodies both wisdom and strength. Athena is often depicted wearing golden armor, a plumed helmet, and wielding a spear and shield. Her shield, the Aegis, features the head of Medusa, symbolizing her power to protect and strike fear into her enemies.'
			},
			beingThree: {
				name: 'POSEIDON',
				image: {
					mobile: 'public/assets/images/greek/poseidon-mobile.jpg',
					tablet: 'public/assets/images/greek/poseidon-tablet.jpg',
					desktop: 'public/assets/images/greek/poseidon-desktop.jpg'
				},
				caption:
		...
		1: {
			beingOne: {
				name: 'MEDUSA',
				image: {
					mobile: 'public/assets/images/greek/medusa-mobile.jpg',
					tablet: 'public/assets/images/greek/medusa-tablet.jpg',
					desktop: 'public/assets/images/greek/medusa-desktop.jpg'
				},
				caption:
			...
			beingTwo: {
				name: 'MINOTAUR',
				image: {
					mobile: 'public/assets/images/greek/minotaur-mobile.jpg',
					tablet: 'public/assets/images/greek/minotaur-tablet.jpg',
					desktop: 'public/assets/images/greek/minotaur-desktop.jpg'
				},
				caption:
			...
			beingThree: {
				name: 'HYDRA',
				image: {
					mobile: 'public/assets/images/greek/hydra-mobile.jpg',
					tablet: 'public/assets/images/greek/hydra-tablet.jpg',
					desktop: 'public/assets/images/greek/hydra-desktop.jpg'
				},
				caption:
					'The Hydra is a legendary multi-headed serpent from Greek mythology, known for its fearsome nature and regenerative powers. Each time one of its heads was cut off, two more would grow in its place, making it nearly invincible. The Hydra dwelled in the swamps of Lerna, a dark and treacherous environment, and was eventually slain by the hero Heracles as one of his Twelve Labors. Heracles used fire to seal the necks.'
			}
		},
		2: {
			beingOne: {
